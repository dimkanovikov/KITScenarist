...
private:
    ...
    /**
     * @brief Находится ли элемент в моменте вызова контекстного меню
     * @note Используется для предотвращения сброса режима редактирования
     */
    bool m_inContextMenuEvent = false;
