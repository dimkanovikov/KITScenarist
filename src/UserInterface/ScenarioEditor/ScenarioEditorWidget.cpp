...
void ScenarioEditorWidget::aboutUpdateStyle()
{
...
void ScenarioEditorWidget::aboutSetStyle()
{
...
void ScenarioEditorWidget::aboutUpdateChronometry()
{
	QString chronText = tr("Chron: ");
	int chronForCursor =
	...
	chronText +=
			ChronometerFacade::secondsToTime(chronForCursor)
			+ " | "
			+ ChronometerFacade::secondsToTime(chronForAll);
	chron()->setText(chronText);
}
...
void ScenarioEditorWidget::initStyleSheet()
{
	...
	//
	setProperty("mainContainer", true);
...
QComboBox* ScenarioEditorWidget::types()
{
	if (m_types == 0) {
...
QRadioButton* ScenarioEditorWidget::textMode()
{
	if (m_textMode == 0) {
...
QLabel* ScenarioEditorWidget::chron()
{
	if (m_chron == 0) {
...
ScenarioTextEdit* ScenarioEditorWidget::scenarioEdit()
{
	if (m_scenarioEdit == 0) {
...
QWidget* ScenarioEditorWidget::spacerWidget(int _width, bool _leftBordered, bool _rightBordered) const
{
